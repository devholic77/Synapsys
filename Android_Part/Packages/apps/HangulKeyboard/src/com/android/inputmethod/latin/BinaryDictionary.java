...
import com.feelnsolar.inputmethod.hangul.WordComposer;
...
public class BinaryDictionary extends Dictionary {
    ...
    static {
        try {
            ...
            Log.e("SoftKeyboard", "Could not load native library jni_latinime UnsatisfiedLinkError");
        } catch (SecurityException se) {
        	Log.e("SoftKeyboard", "Could not load native library jni_latinime SecurityException");
        }
    }
